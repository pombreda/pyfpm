...
#TODO : create one function for all pacman-g2 function !!!
#TODO : create a class for pacman-g2
#TODO : check ignore pkg : pacman_set_option(PM_OPT_IGNOREPKG,pkg) for each package
